...
(function(Buffer) {
  ...
  describe('BN', function() {
    ...
    it('should work with String input', function() {
      ...
      assert.equal(new BN('a89c e5af8724 c0a23e0e 0ff77500', 16).toString(16), 'a89ce5af8724c0a23e0e0ff77500');
      assert.equal(new BN('123456789abcdef123456789abcdef123456789abcdef', 16).toString(16), '123456789abcdef123456789abcdef123456789abcdef');
      assert.equal(new BN('10654321').toString(), '10654321');
      assert.equal(new BN('10000000000000000').toString(10), '10000000000000000');
    ...
    it('should mul numbers', function() {
      assert.equal(new BN(0x1001).mul(new BN(0x1234)).toString(16), '1235234');
      assert.equal(new BN(-0x1001).mul(new BN(0x1234)).toString(16), '-1235234');
      assert.equal(new BN(-0x1001).mul(new BN(-0x1234)).toString(16), '1235234');
      var n = new BN(0x1001);
      var r = n;
      ...
      assert.equal(n.mul(n).toString(16), '39e58a8055b6fb264b75ec8c646509784204ac15a8c24e05babc9729ab9' + 'b055c3a9458e4ce3289560a38e08ba8175a9446ce14e608245ab3a9' + '978a8bd8acaa40');
      assert.equal(n.mul(n).mul(n).toString(16), '1b888e01a06e974017a28a5b4da436169761c9730b7aeedf75fc60f687b' + '46e0cf2cb11667f795d5569482640fe5f628939467a01a612b02350' + '0d0161e9730279a7561043af6197798e41b7432458463e64fa81158' + '907322dc330562697d0d600');
      assert.equal(new BN('-100000000000').mul(new BN('3').div(new BN('4'))).toString(16), '0');
    });
    ...
    it('should mod numbers', function() {
      ...
      assert.equal(new BN('-69527932928').mod(new BN('16974594')).toString(16), '1000');
      var p = new BN('ffffffff00000001000000000000000000000000ffffffffffffffffffffffff', 16);
      var a = new BN('fffffffe00000003fffffffd0000000200000001fffffffe00000002ffffffff' + 'ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 16);
    ...
    it('should support testn', function() {
      ...
      var xbits = ['01111001010111001001000100011101110100111011000110001110010111011001010', '01110000000010110001111010101111100111110010001111000001001011010100111', '01000101001100010001101001011110100001001111100110001110010111'].join('');
